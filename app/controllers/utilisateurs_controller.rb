class UtilisateursController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to utilisateurs_path, status: :see_other, notice: "Utilisateur was successfully destroyed." }
  ...
  private
    ...
    def utilisateur_params
      params.require(:utilisateur).permit(:surnom, :prenom, :age, :email, :bio)
    end
end
