...
class UtilisateursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utilisateur" do
    assert_difference("Utilisateur.count") do
      post utilisateurs_url, params: { utilisateur: { age: @utilisateur.age, bio: @utilisateur.bio, email: @utilisateur.email, prenom: @utilisateur.prenom, surnom: @utilisateur.surnom } }
    end
  ...
  test "should update utilisateur" do
    patch utilisateur_url(@utilisateur), params: { utilisateur: { age: @utilisateur.age, bio: @utilisateur.bio, email: @utilisateur.email, prenom: @utilisateur.prenom, surnom: @utilisateur.surnom } }
